...
pub mod pallet {
    ...
    /// A price of an item.
    #[pallet::storage]
    pub type ItemPriceOf<T: Config> = StorageDoubleMap<
        _,
        Blake2_128Concat,
        T::CollectionId,
        Blake2_128Concat,
    ...
    #[pallet::storage]
    pub type PendingSwapOf<T: Config> = StorageDoubleMap<
        _,
        Blake2_128Concat,
        T::CollectionId,
        Blake2_128Concat,
        ...
        PendingSwap<
            T::CollectionId,
            T::ItemId,
            PriceWithDirection<ItemPrice<T>>,
            BlockNumberFor<T>,
        >,
        OptionQuery,
    >;
    ...
    pub enum Event<T: Config> {
        ...
        SwapCreated {
            ...
            price: Option<PriceWithDirection<ItemPrice<T>>>,
