module.exports = class Data1690706478038 {
    name = 'Data1690706478038'

    async up(db) {
        await db.query(`CREATE TABLE "impl_build" ("id" character varying NOT NULL, "impl_id" integer NOT NULL, "version" integer NOT NULL, "magic_bytes" text, "status" character varying(12) NOT NULL, "online_workers_count" integer NOT NULL, "processing_jobs_count" integer NOT NULL, "successful_jobs_count" integer NOT NULL, "failed_jobs_count" integer NOT NULL, "errored_jobs_count" integer NOT NULL, "panicky_jobs_count" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "deleted_at" TIMESTAMP WITH TIME ZONE, "ref_impl_id" character varying, CONSTRAINT "PK_5a7367725014a952d56efb311d2" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "job_policy" ("id" character varying NOT NULL, "policy_id" integer NOT NULL, "pool_id" integer NOT NULL, "enabled" boolean NOT NULL, "applicable_scope" character varying(6) NOT NULL, "start_block" integer, "end_block" integer, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "deleted_at" TIMESTAMP WITH TIME ZONE, "ref_pool_id" character varying, CONSTRAINT "PK_a24e37e2bc776c5b9ef3b832103" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "pool" ("id" character varying NOT NULL, "pool_id" integer NOT NULL, "owner_address" text NOT NULL, "impl_id" integer NOT NULL, "create_job_enabled" boolean NOT NULL, "auto_destroy_processed_job_enabled" boolean NOT NULL, "metadata" bytea, "workers_count" integer NOT NULL, "online_workers_count" integer NOT NULL, "pending_jobs_count" integer NOT NULL, "processing_jobs_count" integer NOT NULL, "successful_jobs_count" integer NOT NULL, "failed_jobs_count" integer NOT NULL, "errored_jobs_count" integer NOT NULL, "panicky_jobs_count" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "deleted_at" TIMESTAMP WITH TIME ZONE, "ref_owner_id" character varying, "ref_impl_id" character varying, CONSTRAINT "PK_db1bfe411e1516c01120b85f8fe" PRIMARY KEY ("id"))`)
